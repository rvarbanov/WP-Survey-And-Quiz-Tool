...
if ($question['likertscale'] != "Agree/Disagree") {
	...
	<span class="wpsqt_likert_answer"><input type="radio" name="answers[<?php echo $questionKey; ?>]" value="noopinion" id="answer_<?php echo $question['id']; ?>_noopinion" /> <label for="answer_<?php echo $question['id']; ?>_noopinion">No Opinion</label></span>
